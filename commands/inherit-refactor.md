---
description: Inherit an unfamiliar codebase and refactor it incrementally — map first, improve without breaking behavior.
...
code, and risky patterns. Propose a prioritized refactor plan — highest impact,
