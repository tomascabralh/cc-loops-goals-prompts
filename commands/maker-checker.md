---
description: Maker–checker loop — one pass writes, a separate fresh-eyes pass reviews; only integrate what passes.
...
Hard cap: stop after ~10 rounds and report status.

In Claude Code: use separate subagents for maker vs checker — the separate context
